export const translations = {
      ...
      items: [
        {
          ...
          answer: "You can get recipes from TikTok, Instagram, YouTube, and other popular social media platforms. Simply share the video link to Yorigo, and our AI will extract the recipe for you."
        },
        {
  ...
  ko: {
    ...
    faq: {
      ...
      items: [
        {
          question: "어디서 레시피를 얻을 수 있나요?",
          answer: "TikTok, Instagram, YouTube 및 기타 인기 소셜 미디어 플랫폼에서 레시피를 얻을 수 있습니다. 동영상 링크를 요리고에 공유하기만 하면 AI가 레시피를 추출합니다."
        },
        {
